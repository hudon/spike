...
net=nef.Network('Matrix Multiplication',fixed_seed=1) #Create the network object
...
import numeric
net.connect('C','D',transform=numeric.array(transform).T,func=product)
