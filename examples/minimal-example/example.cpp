...
void generate_gain_and_bias(unsigned int count, unsigned int intercept_low,
    unsigned int intercept_high, unsigned int rate_low, unsigned int rate_high,
...
void run_neurons(double * input, double *v, double * ref, double * spikes,
    unsigned int len){
...
void compute_response(double x, double *encoder, double *gain, double *bias,
    unsigned int len, double *count, double time_limit=0.5){
...
void compute_tuning_curves(double * encoder, double *gain, double * bias,
    double * x_values, double * A){
...
void compute_decoder(double * encoder, double * gain, double * bias,
    double (*f)(double)){
