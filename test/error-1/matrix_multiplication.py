...
net.make_array('Array 1', 2, D1 * D2)

# connect inputs to them so we can set their value
net.make_input('Input 1', [0] * D1 * D2)
net.connect('Input 1', 'Array 1')
...
net.make_array('Array 2', 5, D1 * D2 * D3, dimensions = 2,
...
net.connect('Array 1', 'Array 2', transform = numpy.array(transformA).T)
