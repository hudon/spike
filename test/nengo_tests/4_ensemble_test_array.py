...
def test_array():
    ...
    net.make_array('A', neurons=neurons, array_size=3, dimensions=2)
    net.make('C', neurons=neurons, array_size=3, dimensions=2)
    net.make('D', neurons=neurons, array_size=3, dimensions=2)
